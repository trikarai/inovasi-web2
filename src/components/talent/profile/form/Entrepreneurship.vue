              ...
              <v-card-text>
                ...
                <v-row>
                  <v-col md="12" cols="12">
                    <v-select
                      :items="itemPhase"
                      v-model="params.business_category"
...
export default {
  ...
  methods: {
    ...
    addData() {
      ...
      if (!this.edit) {
        this.axios
          .post(config.baseUri + "/talent/entrepreneurship", this.params, {
        ...
        this.axios
          .put(config.baseUri + "/talent/entrepreneurship", this.params, {
            headers: auth.getAuthHeader()
          })
          .then(() => {
            this.$emit("refresh");
