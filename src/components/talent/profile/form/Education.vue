          ...
          <v-card class="pr-3 pl-3">
            <v-form ref="form" v-model="valid">
              ...
              <v-card-text>
                ...
                <v-row>
                  <v-col md="12" cols="12">
                    <v-select :items="itemPhase" v-model="params.phase" label="Phase"></v-select>
                  </v-col>
                </v-row>
                <v-row>
                  <v-col md="12" cols="12">
                ...
                <v-row>
                  <v-col md="12" sm="12" cols="12">
                    <v-textarea v-model="params.note" label="Note" counter="256" maxlength="256"></v-textarea>
                  </v-col>
                </v-row>
              </v-card-text>
              <v-card-actions>
...
export default {
  ...
  methods: {
    ...
    addData() {
      ...
      if (!this.edit) {
        this.axios
          .post(config.baseUri + "/talent/education", this.params, {
        ...
        this.axios
          .put(config.baseUri + "/talent/education", this.params, {
            headers: auth.getAuthHeader()
          })
          .then(() => {
            this.$emit("refresh");
