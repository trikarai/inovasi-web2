              ...
              <v-card-text>
                ...
                <v-row>
                  <v-col md="12" sm="12" cols="12">
                    <v-text-field v-model="params.role" label="Role" counter="50" maxlength="50"></v-text-field>
                  </v-col>
                </v-row>
                <v-row>
                  <v-col md="12" sm="12" cols="12">
...
export default {
  ...
  methods: {
    ...
    addData() {
      ...
      if (!this.edit) {
        this.axios
          .post(config.baseUri + "/talent/working_experience", this.params, {
        ...
        this.axios
          .put(config.baseUri + "/talent/working_experience", this.params, {
            headers: auth.getAuthHeader()
          })
          .then(() => {
            this.$emit("refresh");
